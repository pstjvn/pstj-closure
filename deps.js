...
goog.addDependency('../../../apps/pstj/material/element.js', ['pstj.material.Element', 'pstj.material.ElementRenderer'], ['goog.array', 'goog.async.AnimationDelay', 'goog.dom', 'goog.dom.classlist', 'goog.events.EventType', 'goog.functions', 'goog.ui.Component.State', 'goog.ui.Control', 'goog.ui.ControlRenderer', 'goog.ui.registry', 'pstj.agent.Pointer', 'pstj.agent.Pointer.EventType', 'pstj.agent.Scroll', 'pstj.material.EventMap', 'pstj.material.State', 'pstj.material.template', 'soydata']);
...
goog.addDependency('../../../apps/pstj/material/icon.js', ['pstj.material.Icon'], ['goog.dom', 'goog.object', 'goog.ui.registry', 'pstj.material.Element', 'pstj.material.icons']);
goog.addDependency('../../../apps/pstj/material/input.js', ['pstj.material.Input', 'pstj.material.InputRenderer'], ['goog.format.EmailAddress', 'goog.ui.Component.EventType', 'goog.ui.Component.State', 'goog.ui.registry', 'goog.userAgent', 'pstj.agent.Pointer.EventType', 'pstj.ds.ListItem', 'pstj.ds.ListItem.EventType', 'pstj.lab.style.css', 'pstj.material.Element', 'pstj.material.ElementRenderer', 'pstj.material.FloatingLabel', 'pstj.material.InputBody', 'pstj.material.InputError', 'pstj.material.InputUnderline', 'pstj.material.State', 'pstj.material.template']);
...
goog.addDependency('../../../apps/pstj/material/radiobutton.js', ['pstj.material.RadioButton'], ['goog.ui.Component.State', 'goog.ui.registry', 'pstj.material.Element', 'pstj.material.ElementRenderer', 'pstj.material.EventMap', 'pstj.material.Ripple', 'pstj.material.State', 'pstj.material.template']);
...
goog.addDependency('../../../apps/pstj/material/shadow.js', ['pstj.material.Shadow'], []);
