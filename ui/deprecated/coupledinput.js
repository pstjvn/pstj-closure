 ...
 *   gom.forms.getValue, but mihgt be subject of change in special casses, so
 *   we leave it protected.
 * @protected
 ...
 *   function as to avoid re-initializing the events after changes to the
 *   ckeck function implementation.
 * @private
 ...
 *   if the value matches the primary one.
 * @private
